...
ALARM_PATH := vendor/amy/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/amy/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/amy/prebuilt/common/media/audio/ringtones
